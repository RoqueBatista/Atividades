...
if ($method == "POST") {
    ...
    $resultado = mysqli_query($link, "INSERT INTO cadastro_usuarios.tarefa (titulo, finalizada, id_usuario) VALUES ('$titulo', 0, {$usuario->id})");
...
<body>
	...
	<?php if ( isset($usuario)) {?>
		<a>Usuário online: <?php echo $usuario->usuario; ?></a>
	<?php } else {?>
		<a>Usuário offline</a>
	<?php } ?>
	<h1>Home</h1>
